...
import { asaPriceListData, priceFeedData } from '@/data/static/price-feed';
...
function limitToTwoWords(inputString: string) {
  // Split the input string into words
  const words = inputString.trim().split(/\s+/);

  // Ensure there are at most two words
  if (words.length > 2) {
